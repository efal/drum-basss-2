    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 w-full lg:w-auto">
                ...
                <div className="flex flex-col bg-[#0b1121] p-2 rounded-xl border border-slate-800">
                     ...
                     <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map((val) => (
                            <label key={val} className={`cursor-pointer w-8 h-8 flex items-center justify-center rounded-lg text-sm font-bold transition-all ${
                            octave === val 
            ...
            <div className="flex items-center gap-2 bg-[#0b1121] p-2 rounded-xl border border-slate-800">
                ...
                <button onClick={onSave} className="h-10 w-10 flex items-center justify-center text-slate-500 hover:text-cyan-400 hover:bg-cyan-950/30 rounded-lg border border-transparent hover:border-cyan-900 transition-all" title="Save Pattern">
